...
enum class ERadioMessageInteractionType : uint8_t
{
	...
	VendingMachine                 = 3,
	ERadioMessageInteractionType_MAX = 4
};
...
enum class EInventoryListPackageType : uint8_t
{
	...
	Ground                         = 4,
	Max                            = 5,
	EInventoryListPackageType_MAX  = 6
};
...
enum class ECheatType : uint8_t
{
	...
	ESPLog                         = 168,
	ESPRatioLog                    = 169,
	HighLocationVehicle            = 170,
	HighLocationBoat               = 171,
	HBR_InvalidDashDistance        = 172,
	None                           = 173,
	ECheatType_MAX                 = 174
};
